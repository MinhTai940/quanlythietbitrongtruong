...
INSERT INTO PHIEUMUON (MAPM, NGAYMUON, NGAYLAPPHIEU, NGAYTRA, MANV, MASV, TRANGTHAI, LYDOMUON, LYDOTUCHOI, LYDOHUY, SOLUONGMUON)
VALUES
('PM006', '2025-05-06', '2025-05-05', '2025-05-15', 'NV001', 'SV002', N'Đã trả', N'Mượn thiết bị thuyết trình', NULL, NULL, 1),
('PM007', '2025-05-07', '2025-05-06', '2025-05-14', 'NV002', 'SV003', N'Đang mượn', N'Mượn máy tính làm đồ án', NULL, NULL, 2),
('PM008', '2025-05-08', '2025-05-07', '2025-06-15', 'NV003', 'SV004', N'Đã duyệt', N'Mượn phòng học nhóm', NULL, NULL, 1),
('PM009', '2025-05-09', '2025-05-08', '2025-07-16', 'NV004', 'SV005', N'Từ chối', NULL, N'Thiếu minh chứng', NULL, 1),
('PM010', '2025-05-10', '2025-05-09', '2025-05-20', 'NV005', 'SV001', N'Đã trả', N'Mượn camera an ninh phục vụ dự án', NULL, NULL, 1);
